...
const skillsData = [
  ...
  { id: 4, name: "Bootstrap", icons: <SiBootstrap /> },
  { id: 5, name: "TailWind Css", icons: <SiTailwindcss /> },
  { id: 6, name: "Git & GitHub", icons: <SiGithub /> },
  { id: 7, name: "JavaScript", icons: <SiJavascript /> },
  { id: 8, name: "Node JS", icons: <SiNodedotjs /> },
  { id: 9, name: "Express JS", icons: <SiExpress /> },
  { id: 10, name: "MongoDB", icons: <SiMongodb /> },
          ...
          <div className="col-lg-6 col-xl-5 ms-auto pt-5 pt-lg-0">
            ...
            <div className="experience-user">
              ...
              <div className="avatar">
                <img src="assets/img/Abhishek.jpeg" alt="image" />
              </div>
